# Generated by Django 4.1.1 on 2022-10-06 02:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('job', '0009_alter_job_create_date_alter_job_modified_date'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='job',
            name='create_date',
            field=models.DateTimeField(default=datetime.datetime(2022, 10, 6, 10, 45, 18, 309270), verbose_name='创建日期'),
        ),
        migrations.AlterField(
            model_name='job',
            name='modified_date',
            field=models.DateTimeField(default=datetime.datetime(2022, 10, 6, 10, 45, 18, 309270), verbose_name='修改时间'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_experience', models.TextField(blank=True, max_length=1024, verbose_name='项目经理')),
